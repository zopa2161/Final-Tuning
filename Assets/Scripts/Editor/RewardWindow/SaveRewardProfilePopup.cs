...
public class SaveRewardProfilePopup : EditorWindow
{
    ...
    {
        // 윈도우 생성 (Utility 타입)
        SaveRewardProfilePopup wnd = GetWindow<SaveRewardProfilePopup>(true, "Save Reward Profile", true);
    ...
    {
        // UXML 로드
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/Editor/RewardWindow/SaveRewardProfilePopup.uxml");
